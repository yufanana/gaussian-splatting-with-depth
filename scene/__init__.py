...
class Scene:
    ...
    def __init__(self, args : ModelParams, gaussians : GaussianModel, load_iteration=None, shuffle=True, resolution_scales=[1.0]):
        ...
        if os.path.exists(os.path.join(args.source_path, "sparse")):
            ...
            scene_info = sceneLoadTypeCallbacks["Colmap"](args.source_path, args.images, args.eval) #modified colmap data routine to use sonar data
        ...
        # elif os.path.exists(os.path.join(args.source_path, "Sonar_raw")):
        #     print("Found Sonar_raw, assuming Sonar dataset!")
        #     scene_info = sceneLoadTypeCallbacks["Sonar"](args.source_path, args.white_background, args.eval)
        else:
